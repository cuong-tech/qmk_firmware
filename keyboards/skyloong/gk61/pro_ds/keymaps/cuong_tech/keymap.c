...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
        ...
        KC_LALT,  KC_LCTL,    KC_LGUI,             LT(2, KC_ENT),   KC_TAB,     LT(2, KC_SPC),  KC_CAPS,      KC_LEFT,     KC_DOWN,               KC_RIGHT
    ),
    ...
    [1] = LAYOUT_all(
        ...
        KC_LSFT,  LGUI_T(KC_Z),       KC_X,       KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,    KC_UP,
        KC_LCTL,  KC_LGUI,    KC_LALT,             LT(2, KC_ENT),   KC_TAB,                 LT(2, KC_SPC),  KC_CAPS,      KC_LEFT,     KC_DOWN,              KC_RIGHT
    ),
