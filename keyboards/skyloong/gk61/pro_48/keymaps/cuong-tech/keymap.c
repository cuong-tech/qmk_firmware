...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
        ...
        // LGUI_T(KC_ESC),  LCTL_T(KC_A),       LALT_T(KC_S),       LSFT_T(KC_D),     LGUI_T(KC_F),     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     LCTL_T(KC_SCLN),    KC_QUOT,            KC_ENT,
        // LGUI_T(KC_ESC),  LCTL_T(KC_A),       LALT_T(KC_S),       LSFT_T(KC_D),     LGUI_T(KC_F),     KC_G,     KC_H,     LGUI_T(KC_J),     LSFT_T(KC_K),     LALT_T(KC_L),     LCTL_T(KC_SCLN),    KC_QUOT,            KC_ENT,
        ...
        KC_LALT,  KC_LCTL,    KC_LGUI,             LT(5, KC_ENT),   KC_TAB,     KC_MUTE,               LT(4, KC_SPC),  KC_CAPS,      KC_APP,     KC_RCTL,               MO(6)
    ),

    [1] = LAYOUT_all(
         KC_GRV,   KC_1,       KC_2,       KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,       KC_MINS,  KC_EQL,   KC_BSLS,
         KC_TAB,   KC_Q,       KC_W,       KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,       KC_LBRC,  KC_RBRC,  KC_BSPC,
        // LGUI_T(KC_ESC),  LGUI_T(KC_A),       LALT_T(KC_S),       LSFT_T(KC_D),     LCTL_T(KC_F),     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     LGUI_T(KC_SCLN),    KC_QUOT,            KC_ENT,
        // LGUI_T(KC_ESC),  LGUI_T(KC_A),       LALT_T(KC_S),       LSFT_T(KC_D),     LCTL_T(KC_F),     KC_G,     KC_H,     LCTL_T(KC_J),     LSFT_T(KC_K),     LALT_T(KC_L),     LGUI_T(KC_SCLN),    KC_QUOT,            KC_ENT,
        LCTL_T(KC_ESC),  KC_A,       KC_S,       KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,    KC_QUOT,            KC_ENT,
        KC_LSFT,  LGUI_T(KC_Z),       KC_X,       KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,    KC_RSFT,
        KC_LCTL,  KC_LGUI,    KC_LALT,             LT(5, KC_ENT),   KC_TAB,     KC_MUTE,               LT(4, KC_SPC),  KC_CAPS,      KC_APP,     KC_RCTL,               MO(6)
    ),
