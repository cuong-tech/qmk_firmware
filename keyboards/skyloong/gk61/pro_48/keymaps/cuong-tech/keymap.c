...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
        ...
        KC_LSFT,  LGUI_T(KC_Z),       KC_X,       KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,    KC_UP,
        KC_LALT,  KC_LCTL,    KC_LGUI,             LT(2, KC_ENT),   KC_TAB,     KC_MUTE,               LT(2, KC_SPC),  KC_CAPS,      KC_LEFT,     KC_DOWN,               KC_RIGHT
    ),
    ...
    [1] = LAYOUT_all(
        ...
        KC_LSFT,  LGUI_T(KC_Z),       KC_X,       KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,    KC_UP,
        KC_LCTL,  KC_LGUI,    KC_LALT,             LT(2, KC_ENT),   KC_TAB,     KC_MUTE,               LT(2, KC_SPC),  KC_CAPS,      KC_LEFT,     KC_DOWN,              KC_RIGHT
    ),

    [2] = LAYOUT_all(
        KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,       KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   TO(1),
        _______,  _______,  _______,  KC_DEL,  _______,  _______,     _______,  LEFT_WORD,  KC_UP,  RIGHT_WORD,  _______,  _______,  _______,  TO(0),
