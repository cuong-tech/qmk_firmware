...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT( /* FN */
        ...
        _______,  DT_PRNT,    DT_DOWN,    DT_UP,  _______,  _______,  _______,  _______,  KC_UP,  _______,  _______,    KC_HOME,  KC_SCRL,  _______,   KC_INS,
        _______, TO(0),  TO(2),      _______,  _______,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_RIGHT,  _______,    KC_PSCR,            _______,   KC_PAUSE,
    ...
    [2] = LAYOUT( /* Base Mac */
        ...
        KC_LSFT,  KC_Z,       KC_X,       KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,    KC_RSFT,            KC_UP,     KC_PGDN,
        KC_LALT,  KC_LCTL,    KC_LGUI,                        LT(3, KC_SPC),                       KC_RALT,  MO(3),                KC_LEFT,            KC_DOWN,   KC_RGHT
        ),
